...
public class GestionarPersonal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Cédula/DPI", "Nombre", "Apellido Paterno", "Apellido Materno", "Fecha Nacimiento", "Dirección", "Celular", "Genero"
            }
        ) {
    ...
    private void ingresarPersonal() throws FileNotFoundException, UnsupportedEncodingException, IOException{
        ...
        escribirArchivo.write(txtCedula.getText()+"\t"+txtNombre.getText()+"\t"+txtApellidoPaterno.getText()+"\t"+txtApellidoMaterno.getText()+"\t"+txtFechaNacimiento.getText()+"\t"+txtDireccion.getText()+"\t"+txtCelular.getText()+"\t"+txtConvencional.getText()+"\n");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (!(txtCedula.getText().equals("")||txtNombre.getText().equals("")||txtApellidoPaterno.getText().equals("")||txtApellidoMaterno.getText().equals("")||txtFechaNacimiento.getText().equals("")||txtDireccion.getText().equals("")||txtCelular.getText().equals("")||txtConvencional.getText().equals(""))) {
    ...
    public void almacenarFichero() throws IOException{
        ...
        BufferedWriter escribirArchivo = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(archivo,true),"utf-8"));
        for (int i = 0; i < jTable1.getRowCount(); i++) {
            escribirArchivo.write(jTable1.getValueAt(i, 1)+"\t"+jTable1.getValueAt(i, 2)+"\t"+jTable1.getValueAt(i, 3)+"\t"+jTable1.getValueAt(i, 4)+"\t"+jTable1.getValueAt(i, 5)+"\t"+jTable1.getValueAt(i, 6)+"\t"+jTable1.getValueAt(i, 7)+"\t"+jTable1.getValueAt(i, 8)+"\n");
        }
        escribirArchivo.close();
        leerArchivo();
    }
